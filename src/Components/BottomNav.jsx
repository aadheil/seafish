...
function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 w-full bg-white shadow-lg h-16 flex justify-around items-center" style={{fontFamily:"Ropa sans"}}>
      <div onClick={()=>navigate('/')} className="flex flex-col items-center text-gray-600 hover:text-blue-500">
      ...
      <div onClick={()=>navigate('/list')} className="flex flex-col items-center text-gray-600 hover:text-blue-500">
        <Icon icon="ic:baseline-format-list-bulleted" width="24" /> {/* Updated for ordered list */}
        <span className="text-sm">List</span>
      </div>
      <div onClick={()=>navigate('/track')} className="flex flex-col items-center text-gray-600 hover:text-blue-500">
